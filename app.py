...
def load_google_files_registry():
    try:
        ...
        # Резервные заглушки, если нет сети
        return {
...
st.markdown("Вставь сюда скопированную из Excel ячейку **«Файлы на Google Drive»** или введи имя файла / модели руками.")

# Только ОДНО поле для ввода — максимально просто
search_query = st.text_area(
    "Запрос для поиска или буфер обмена:",
    placeholder="Вставь скопированное из Excel или напиши имя файла...",
    height=120,
...
if st.button("Найти файлы на Диске", type="primary", use_container_width=True):
    if not search_query.strip():
        st.warning("Поле пустое. Вставь данные из Excel.")
    else:
        st.markdown("---")
        ...
        # СЦЕНАРИЙ 2: Обычный текстовый поиск по имени или модели
        else:
